...
features:
  - icon: 🧠
    title: AI 与工程师的重塑
    details: 从根本上重新探讨在全自动化代码生成时代，软件工程师应如何通过“架构先行”来破局自身价值。
    link: /guide/1-crisis
  - icon: 🛡️
    title: 强制且铁血的工程流程
    details: 真正的工程防线在于纪律。学习如何通过强制调研、规划、砌砖的 SOP 实现逻辑的工业级隔离。
    link: /SOP
  - icon: ⚡
    title: 开箱即用的无瑕指令库
    details: 依托经过极限打磨的系统指令范式（PROMPTS），以及将 SOLID 等原则深刻注入的系统底层墙（Rules）。
    link: /PROMPTS
---
